...
__all__ = ['StepLRScheduler', 'CosineLRScheduler']
...
class _WarmUpLRScheduler(_LRScheduler):
    ...
    def __init__(self, optimizer, base_lr, warmup_lr, warmup_steps, last_iter):
...
class StepLRScheduler(_WarmUpLRScheduler):
    def __init__(self, optimizer, milestones, lr_mults, base_lr, warmup_lr, warmup_steps, last_iter):
...
class CosineLRScheduler(_WarmUpLRScheduler):
    def __init__(self, optimizer, T_max, eta_min, base_lr, warmup_lr, warmup_steps, last_iter):
